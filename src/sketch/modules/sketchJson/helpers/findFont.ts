...
import { TextStyle } from '@/sketch/modules/sketchJson/helpers/fixFont';
...
/**
 * 根据字体名称找到字体家族
 * @param {string} familyName 字体名称
 */
const fontNamesForFamilyName = (familyName: string): string[] => {
...
const findFont = (style: TextStyle): NSFont => {
  ...
  const defaultFontFamily = String(NSFont.systemFontOfSize(14).familyName());
  ...
  if (style.fontFamily && style.fontFamily !== '-apple-system') {
